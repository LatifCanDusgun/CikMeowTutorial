...
public class HolyWheatCollectible : MonoBehaviour, ICollectible
{
    ...
    public void Collect()
    {
        ...
        _playerStateUI.PlayerBoosterUIAnimations(_playerBoosterTransform, _playerBoosterImage, _playerStateUI.GetHolyBoosterWheatImage, _wheatDesignSO.ActiveSprite,
